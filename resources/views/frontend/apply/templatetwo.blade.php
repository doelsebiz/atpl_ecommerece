		               ...
		               <div >
		                  ...
		                  <div  class="policy-details">
		                        ...
		                        <div  class="policy-details__row">
		                           ...
		                           <div  class="policy-details__row--value"> {{ Cmf::date_format($year) }}</div>
		                        </div>
		                        @endfor
		                  </div>
...
name.addEventListener('input', function () {
    if (name.value.length == 0) {
        document.getElementById('svgname').innerHTML = 'Abubakar';
        document.getElementById('svgnameback').innerHTML = 'Abubakar';
    } else {
