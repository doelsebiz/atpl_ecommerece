...
@php
    $page = DB::table('travelpages')->where('url' , 'social-media-app')->first();
@endphp
@section('tittle')
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-7 col-lg-6">
            <div class="hero-txt white-color">
               ...
               <h2 style="font-size: 2.75rem;" class="h2-lg animated" data-animation="fadeInUp" data-animation-delay="300">
                  Launch Your Customized Social Media Application
               </h2>
               <!-- Text -->
               <p class="p-lg animated" data-animation="fadeInUp" data-animation-delay="400">
                  Our technology solutions help you create interactive social media apps like Facebook & Instagram
               </p>
         ...
         <div class="col-md-5 col-lg-5 offset-lg-1 animated" data-animation="fadeInRight" data-animation-delay="400">
            <div class="">
            	<img src="https://cdn-gnpmp.nitrocdn.com/zXfatNvCxdJLOJQwdBcjdAFpyWHclmaD/assets/images/optimized/rev-549b063/www.code-brew.com/wp-content/uploads/2020/02/hath@3x-1.png">
            </div>
         </div>
      </div>
      <!-- End row -->
