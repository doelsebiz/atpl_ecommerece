...
$(function () {
    $("#sum_slider_for_price_layout").slider({
        ...
        value: iValue,
        slide: function (event, ui) {
            $('#coverage_amount_for_price_layout').text(SliderValues[ui.value]);
            ...
            $( "#coverage_amount_for_price_layout" ).val( "$" + SliderValues[ui.value] );
...
?>
    <div class="container" style="padding-top:20px">
        <div class="row filterdiv hidden-xs" style="margin-bottom: 10px; border: 1px solid #ddd;text-align: center;padding-top: 10px; background:#FFF;">
            ...
            <div class="col-md-3 adjust-quoto coverage-mobile-view" style="border-top:0px; ">
                <h4 class="coverage"
                    ...
                    Coverage: <input type="text" id="coverage_amount_for_price_layout" name="coverage_amount"
                ...
                <div id="sum_slider_for_price_layout"
                    style="border: 1px solid #c5c5c5;padding: 5px;box-shadow: 0px 0px 5px 0px inset #CCC;border-radius: 10px;">
                </div>
            </div>
        ...
        <div class="row">
            @if (in_array('yes', $request->pre_existing))
                @include('frontend.travelinsurance.includes.one.yes')
            @else
                @include('frontend.travelinsurance.includes.one.yes')
                @include('frontend.travelinsurance.includes.one.no')
            @endif
        </div>
        <!--    row end-->
    </div>
