<div class="row">
    <div class="col-md-12 right-bar-content padding-left-zero-on-mobile" id="listprices" style="padding-right:0;">
...
@if(DB::table('wp_dh_insurance_plans_features')->where('plan_id' , $plan_id)->count() > 0)
<div class="row">
    <div class="col-md-12">
            ...
            <div class="col-md-12">
                <ul style="list-style-type: disc">
                    ...
                    <li style="list-style: circle;margin-left: 20px;line-height: 20px;">
                        <b>{{ $test }}</b>{{ str_replace($test, '', $feature->features) }}</div>
                    </li>
                </ul>
...
<div class="col-md-3 text-center" style="padding-top: 5px; padding-bottom: 5px;">
   ...
   <p class="text-center" style="font-size:12px;">This rate is for ${{ $deductible }} deductible options</p>
   <div class="col-md-12 col-xs-12" >
      ...
      <div class="compare hidden-xs">
        ...
        @else
         <label onclick="savecompareplans('{{ $savetoplan }}')" class="col-md-12 col-xs-5 text-center text-white comparebutton" id="compare">
