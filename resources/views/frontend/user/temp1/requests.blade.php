   ...
   <div class="row mt-5">
      <div class="col-md-12">
         <div class="heading-wrapper">
            <h1 class="heading-2 text-md-center">All Requests</h1>
         </div>
      </div>
               ...
               <div class="tabs-container">
                  <div class="tabs-block">
                     <div id="tabs-section" class="tabs">
                        <ul class="tab-head">
                           <li>
                              <a href="#tab-1" class="tab-link active"> <span class="material-icons tab-icon">Change</span> <span class="tab-label">Change Requests</span></a>
                           </li>
                           <li>
                              <a href="#tab-2" class="tab-link"> <span class="material-icons tab-icon">Refund</span> <span class="tab-label">Refund Requests</span></a>
                           </li>
                           <li>
                              <a href="#tab-3" class="tab-link"> <span class="material-icons tab-icon">Extend</span> <span class="tab-label">Extend Requests</span></a>
                           </li>
                        </ul>
                                  ...
                                  <div class="accordion-body">
                                     <div class="row">
                                       <div class="col-md-6">
                                           ...
                                           <a class="badge badge-success" href="javascript:void(0)">{{ $r->request_status }}</a>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                           ...
                                           <a download="" class="btn btn-primary" href="{{ url('public/images') }}/{{ $r->document }}">Download</a>
                                        </div>
                                     </div>
                                  </div>
                                </li>
                                       ...
                                       <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                           <label>Refund Form</label><br>
                                            <a download="" class="btn btn-primary" href="{{ url('public/images') }}/{{ $r->refund_form }}">Refund Form</a>
                                        </div>
                                        <div class="col-md-6">
                                           <label>Proof Of Return</label><br>
                                           <a download="" class="btn btn-primary" href="{{ url('public/images') }}/{{ $r->proof_of_return }}">Proof Of Return</a>
                                        </div>
                                     </div>
                                  </div>
                                </li>
