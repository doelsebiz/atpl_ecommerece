...
@section('tittle')
<title>{{ $data->name }} | Portfolio | ATPL</title>
            ...
            <div class="breadcrumb-wrapper">
               <div class="breadcrumb-cnt">
                  ...
                  <div class="breadcrumb-list">
                     <a href="{{ url('') }}">Home</a><img src="{{ url('public/assets/img/inner-pages/breadcrumb-arrow.svg') }}" alt><a href="{{ url('portfolio') }}">Portfolio</a><img src="{{ url('public/assets/img/inner-pages/breadcrumb-arrow.svg') }}" alt> {{ $data->name }}
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="col-lg-8">
            <div class="portfolio-content">
               ...
               <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh elementum, accumsan ona
                  ...
                  ut, hendrerit vel tortor. In pharetra lectus luctus ornare sollicitudin.
               </p>
               <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh elementum, accumsan ona
                  neque ac, aliquet nunc. In eu ipsum fringilla, accumsan purus vel, pellentesque risus. Vivamus vehicula nl
                  pellentesque quis magna eu vestibulum. Ut sed commodo neque. Morbi erat nisi, vehicula quis faucibus il
