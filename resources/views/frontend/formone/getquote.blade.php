        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15 text-center">We are Fetching Youre Quotes</span>
              <br><br>
                    ...
                    @foreach ($quotedata as $key=>$dt)
                        @if(is_array($dt))
                            ...
                            @if($key == 'years')
                                ...
                                @foreach($dt as $year)
                                    <input type="hidden" value="{{ $year }}" name="years[]">
                        ...
                        @else
                            ...
                            @else
                            <input type="hidden" value="{{ $dt }}" name="{{ $key }}">
                            @endif
                        @endif
