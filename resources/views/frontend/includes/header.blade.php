         ...
         <form class="mobile-menu-form">
            ...
            <div class="email pt-20 d-flex align-items-center">
               ...
               <div class="email-info">
                  <span>Email Now</span>
                  <h6><a href=""><span class="__cf_email__" data-cfemail="e5809d8488958980a58288848c89cb868a88">[email&#160;protected]</span></a></h6>
               </div>
            </div>
         </form>
         <div class="header-btn5">
            <a class="primary-btn3" href="{{ url('contact-us') }}">Get A Quote</a>
         </div>
      </div>
   </div>
