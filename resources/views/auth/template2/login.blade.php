...
@section('content')
    ...
    <section class="chooses-blogs chooses-blogs-responsive choose-us-area-five pt-5"
                ...
                <div class="col-md-6">
                    ...
                    <div class="customized-login-card">
                        <div class="sign-in--header">
                            ...
                            <p class="subheader text-secondary-color"> Sign in with your Policy ID and Date of Birth below
                                and get easy, 24/7 access to manage your policy details, documents, and more! </p>
                        </div>
                        <div class="card-body">
                            <ul class="nav nav-tabs ah-custom-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">Reffrence
                                        ID</a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 nopad mt-3">
                                                ...
                                                @else
                                                    ...
                                                    value="{{ old('reffrence_id') }}" @endif
                                                        class="input" type="text" placeholder="" name="reffrence_id">
                                                    @error('reffrence_id')
                                                ...
                                                <div class="custom-form-control positionrelative">
                                                   ...
                                                   @else
                                                       ...
                                                       value="{{ old('date_of_birth') }}" @endif
                                                        id="dateofbirthfull" class="input" type="text"
                                                        placeholder="MM/DD/YYYY" name="date_of_birth">
                                                    @error('date_of_birth')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <div
                                                    ...
                                                    <strong>Note:</strong> If you previously created an account with your
                                                    Email Address, you can now simply login with your Policy ID and Date of
                                                    Birth. </div>
                                            </div>
                                            <div class="col-md-12 mt-3">
        ...
        <div class="modal fade" id="whereismypolicyid" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-md modal-dialog-centered" role="document">
                <div class="modal-content"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-5"
                            style="max-width: 70%;margin: auto;border: 1px solid #c2cad7;box-shadow: 0 4px 16px rgba(87,106,134,.15);border-radius: 8px;"
                            class="main-image">
