    ...
    * {
    ...
    @media (max-width: 480px) {
      ...
      #u_column_3 .v-col-border {
        border-top: 1px solid #169179 !important;
        border-left: 0px solid transparent !important;
        border-right: 0px solid transparent !important;
        border-bottom: 1px solid #169179 !important;
      }
        ...
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tbody>
                                  <tr>
                                    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;"
                                      align="center">

                                      <img align="center" border="0"
                                        src="https://lifeadvice.ca/public/images/118135255.png" alt="image"
                                        title="image"
                                        style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 30%;max-width: 160px;"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-color v-text-align v-font-size"
                                style="color: #2b3481; margin: 0px; line-height: 120%; text-align: center; word-wrap: break-word; font-size: 30px; ">
                                <strong>Policy Confirmation <br>Thank you for your purchase! <br>Reffrence ID: {{
                                  $policy_number }}</strong></h1>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;"
                                      ...
                                      <p style="padding: 0px 20px;color: #868686;">We truly appreciate your trust in our
                                        services and your decision to purchase an insurance policy with us. Your policy
                                        details and documentation will be emailed to you shortly. Please take the time
                                        to read them carefully and familiarize yourself with the terms and conditions.
                                        If you have any questions or need any assistance in understanding the specifics,
            ...
            <div class="u-row"
              ...
              <div
                ...
                <div id="u_column_3" class="u-col u-col-33p33"
                  ...
                  <div
                    style="background-color: #12b48b;height: 100%;width: 100% !important;border-radius: 0px;border-top-left-radius: 20px;border-top-right-radius: 20px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div class="v-col-border"
                      ...
                      <table id="u_content_text_3" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;font-family:'Open Sans',sans-serif;"
                              align="left">

                              <div class="v-color v-text-align v-font-size"
                                style="padding-top: 10px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%;font-size: 28px;color: white;">
                                  <strong>Manage your policy</strong>
                                </p>
                                <p style="line-height: 140%;font-size: 16px;padding-top: 5px;color: white;">Did you know
                                  you can manage your policy online? Quickly manage and verify your policy information
                                  by signing in to your account below.</p>
                              </div>
            ...
            <div class="u-row"
              ...
              <div
                ...
                <div class="u-col u-col-100"
                  style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                  <div
                    style="background-color: #12b48b;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div class="v-col-border"
                      style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                      <!--<![endif]-->
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-color v-text-align v-font-size"
                                style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;padding-top: 5px;">
                                <a href="{{ url('login') }}"
                                  style="background-color:#2b3481;border:1px solid #2b3481;border-color:#2b3481;border-radius:50px;border-width:1px;color:#ffffff;display:inline-block;font-size:14px;font-weight:700;letter-spacing:0px;line-height:normal;padding:12px 46px 12px 46px;text-align:center;text-decoration:none;border-style:solid"
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              ...
              <div
                ...
                <!--[if (mso)|(IE)]><td align="center" width="200" class="v-col-border" style="background-color: #56beba;width: 200px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                <div id="u_column_2" class="u-col u-col-33p33"
                  style="max-width: 320px;min-width: 200px;display: table-cell;vertical-align: top;">
                  <div
                    style="background-color: #12b48b;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div class="v-col-border"
                      ...
                      <table id="u_content_text_5" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 25px 0px;font-family:'Open Sans',sans-serif;"
                              align="left">

                              <div class="v-color v-text-align v-font-size"
                                style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%;color: white;"><strong>Download policy documents</strong>
                                </p>
                              </div>
                      ...
                      <table id="u_content_text_5" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 25px 25px;font-family:'Open Sans',sans-serif;"
                              align="left">

                              <div class="v-color v-text-align v-font-size"
                                style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%;color: white;"><strong>Correct or cancel your
                                    policy</strong></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-color v-text-align v-font-size"
                                style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%;color: white;"><strong>Repurchase your policy</strong></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-color v-text-align v-font-size"
                                style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%;color: white;"><strong>Request claims assistance</strong>
                                </p>
                              </div>
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
              <div class="u-row"
                style="background-color: #dae8e7;font-size: 28px;text-align: center;padding-top: 10px;color: #2b3481; font-family: 'Open Sans',sans-serif;">
                <strong>Policy Information</strong> </div>
              <div
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">

                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent;"><![endif]-->

                <!--[if (mso)|(IE)]><td align="center" width="310" class="v-col-border" style="background-color: #dae8e7;width: 310px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                <div class="u-col u-col-51p83"
                  style="max-width: 320px;min-width: 310.98px;display: table-cell;vertical-align: top;">

                  <div
                    style="background-color: #dae8e7;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div class="v-col-border"
                      style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                      <!--<![endif]-->
                      ...
                      <table id="u_content_heading_4" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 0px 30px;font-family:'Open Sans',sans-serif;"
                              align="left">

                              <h1 class="v-color v-text-align v-font-size"
                                style="color: #2b3481; margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; ">
                                <strong>
                                  Policy Status</strong></h1>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <p class="v-color v-text-align v-font-size"
                                style="color:  rgb(83, 83, 83);margin: 0px; line-height: 140%; text-align: end; word-wrap: break-word; font-size: 16px; ">
                ...
                <!--[if (mso)|(IE)]></td><![endif]-->
                <!--[if (mso)|(IE)]><td align="center" width="289" class="v-col-border" style="background-color: #dae8e7;width: 289px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            ...
            <div class="u-row"
              ...
              <div class="u-row"
                style="background-color: #dae8e7;font-size: 30px;color: #2b3481; text-align: center;padding-top: 30px;font-family: 'Open Sans',sans-serif;">
                <strong>Traveler Information {{ $key+1 }}</strong> </div>
              <div
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                    ...
                    <div class="v-col-border"
                      ...
                      <table id="u_content_text_8" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 30px 30px;font-family:'Open Sans',sans-serif;"
                              align="left">
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-color v-text-align v-font-size"
                                style="color: #2b3481; margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; ">
                                <strong>Got Questions?</strong></h1>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-color v-text-align v-font-size"
                                ...
                                <p style="line-height: 140%;">Feel Free To Contact Us</p>
                              </div>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-text-align" align="center">
                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.unlayer.com" style="height:37px; v-text-anchor:middle; width:203px;" arcsize="67.5%"  stroke="f" fillcolor="#56beba"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Open Sans',sans-serif;"><![endif]-->
                                <a href="" target="_blank" class="v-button v-size-width v-font-size"
                                  style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #12b48b; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:40%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                  <span style="display:block;padding:10px 20px;line-height:120%;"><strong><span
                                        style="line-height: 16.8px;">Contact Us</span></strong></span>
                                </a>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;"
                                      ...
                                      <img align="center" border="0"
                                        src="https://lifeadvice.ca/public/front/img/images/2.png" alt="image"
                                        title="image"
                ...
                <div class="u-col u-col-100"
                  ...
                  <div
                    ...
                    <div class="v-col-border"
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://www.facebook.com/lifeadviceinsurance/" title="Facebook"
                                            target="_blank">
                                            <img src="https://cdn.tools.unlayer.com/social/icons/rounded/facebook.png"
                                  ...
                                  <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32"
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                          <a href="https://www.linkedin.com/in/life-advice-insurance-inc-3a7074138"
                      ...
                      <table id="u_content_text_deprecated_1" style="font-family:'Open Sans',sans-serif;"
