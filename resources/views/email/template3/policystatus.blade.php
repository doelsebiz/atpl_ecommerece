...
<img border="0" style="display:block;color:#000000;text-decoration:none;font-family:Helvetica,arial,sans-serif;font-size:16px;width: 40%;height: 100%;" width="200" alt="" src="https://lifeadvice.ca/public/images/118135255.png" height="41" class="CToWUd" data-bit="iit">
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="padding:18px 30px 18px 30px;line-height:22px;text-align:inherit;@if($status != 'Cancel') background-color:#2b3481; @else background-color:red; @endif" height="100%" valign="top" bgcolor="#2B3481" role="module-content">
<div>
<div style="font-family:inherit;text-align:inherit"><span style="color:#ffffff;font-family:&quot;Open Sans&quot;,sans-serif;font-size:18px;line-height:40px;font-weight:700">

@if($status != 'Cancel')
Your Policy Number is Generated {{ $policynumber }}
@else

Your Policy is Canceled Due To the following Reason

@endif
</span></div>
<div style="font-family:inherit;text-align:inherit"><br></div>
<div style="font-family:inherit;text-align:inherit"><span style="color:#ffffff;font-family:&quot;Open Sans&quot;,sans-serif;font-size:18px;line-height:40px;font-weight:600">Reffrence Number : </span><span style="color:#ffffff;font-family:&quot;Open Sans&quot;,sans-serif;font-size:18px;line-height:40px;font-weight:700">  {{ $reffrence_number }}</span></div>
<div></div>
</div>
</td>
</tr>
...
<table role="module" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
   <tbody>
      <tr>
         <td style="padding:25px 30px 0px 30px;line-height:28px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
            <div>
               <div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit;line-height:28px"><span style="color:#67778f;font-weight:500;font-size:14px">{{ $cancelreason }}</span>
               </div>
            </div>
         </td>
      </tr>
...
@php
    $sale = DB::table('sales')->where('reffrence_number' , $reffrence_number)->first();
@endphp
...
<td style="padding:10px 0px 10px 0px;line-height:24px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
<div>
<div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit"><span style="white-space:pre-wrap;font-family:&quot;Open Sans&quot;,sans-serif;font-size:14px;line-height:24px;font-weight:600;color:#67778f">{{ Cmf::date_format($r->date_of_birth) }}</span></div>
<div></div>
</div>
</td>
</tr>
