...
@section('title','All Plan Benifit Categories')
@section('content')
            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">
                            All Plan Benifit Categories
                            <div class="text-muted pt-2 font-size-sm">Manage All Plan Benifit Categories</div>
                        </h3>
                    </div>
                            ...
                            <div class="modal fade" id="categoryedit{{ $r->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/plans/updatbenifitcategory') }}">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="icon" type="file" id="emailfield" class="form-control" style="height:45px;">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="5" name="description">{{ $r->description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="modal-title" id="exampleModalLabel">Add New Plan Benifit Category</h5>
                    </div>
                </div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/plans/addnewbenifitcategory') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
