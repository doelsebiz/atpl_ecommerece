                ...
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">
                            ...
                            <div class="text-muted pt-2 font-size-sm">Manage All Products Categories</div>
                        </h3>
                    </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p style="color:red;">Are you Sure You want to delete this. If you Delete this Category then All Products will be deleted Automaticaly against this Category</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Close</button>
                                            <a href="{{ url('admin/products/deleteproductcategory') }}/{{ $r->id }}" class="btn btn-danger font-weight-bold">Yes, Delete it</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" id="categoryedit{{ $r->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/products/updatproductcategory') }}">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="description">{{ $r->description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="lable-control">Vector</label>
                                                            <input name="vector"  type="file" id="emailfield" class="form-control  form-control-solid font-size-lg pl-5 min-h-50px">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="lable-control">Show On</label>
                                                            <select class="form-control  form-control-solid font-size-lg pl-5 min-h-50px" name="show_on"> 
                                                                <option @if($r->show_on == 'Left') selected @endif value="Left">Left Side</option>
                                                                <option @if($r->show_on == 'Right') selected @endif value="Right">Right Side</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
...
<div class="modal fade" id="exampleModalScrollable" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/products/createproductcategory') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="lable-control">Enter Name</label>
                                <textarea name="name" required id="emailfield" class="summernote"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="lable-control">Vector</label>
                                <input name="vector" required type="file" id="emailfield" class="form-control  form-control-solid font-size-lg pl-5 min-h-50px">
                            </div>
                        </div>
                    </div>
                    <div class="row">
